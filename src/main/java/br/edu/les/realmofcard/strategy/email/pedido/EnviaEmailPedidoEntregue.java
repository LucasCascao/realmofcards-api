...
@Log4j2
@Component
public class EnviaEmailPedidoEntregue implements IStrategy {
    ...
    public String processar(EntidadeDominio entidade) {
    	...
    	if(entidade instanceof Pedido) {
    		...
    		mensagem.setAssunto("Confirmação da entrega do pedido.");

    		mensagemTexto.append("Prezado " + cliente.getNome() + " " + cliente.getSobrenome() + ", ");
    		mensagemTexto.append("este email foi enviado para confirmar que seu pedido foi entregue com sucesso.\n");
