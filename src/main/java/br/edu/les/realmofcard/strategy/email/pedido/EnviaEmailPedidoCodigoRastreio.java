...
@Log4j2
@Component
public class EnviaEmailPedidoCodigoRastreio implements IStrategy {
    ...
    public String processar(EntidadeDominio entidade) {
    	...
    	if(entidade instanceof Pedido) {
    		...
    		mensagem.setAssunto("Envio do código de rastreio do envio do pedido.");

    		mensagemTexto.append("Prezado " + cliente.getNome() + " " + cliente.getSobrenome() + ", ");
    		mensagemTexto.append("este email foi enviado para diponibilizar o código de rastreio de sua compra.\n");
    		mensagemTexto.append("Seu código de rastrio é " + pedido.getRastreio().getCodigoRastreio() + ".\n");
